...
<body>
    ...
    <form action="homeAddProduct.php" method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label>Shto Produktin tek HOME PAGE</label>
        ...
        <?php include_once 'controller/homeProductController.php' ?>
    </form>
