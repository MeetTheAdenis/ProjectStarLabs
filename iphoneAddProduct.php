...
<body>
    ...
    <form action="iphoneAddProduct.php" method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label>Shto Produktin te faqja iPHONE</label>
        ...
        <?php include_once 'controller/iphoneProductController.php' ?>
    </form>
