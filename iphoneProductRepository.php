...
class iphoneProductRepository{
    ...
    function insertProduct($user){
        ...
        $sql = "INSERT INTO iphoneproduct (id,title,subtitle,image) VALUES (?,?,?,?)";
    ...
    function getAllProducts(){
     ...
     function getProductById($id){
       ...
       $sql = "SELECT * FROM iphoneproduct WHERE id='$id'";
       $statement=$conn->query($sql);
     ...
     function updateProduct($id,$title,$subtitle,$image){
         ...
         $sql = "UPDATE iphoneproduct SET title=?,subtitle=?,image=? where id=?";
     ...
     function deleteproductById($id){
         $conn = $this->connection;
         $sql = "DELETE FROM iphoneproduct WHERE id=?";
         $statement = $conn->prepare($sql);
